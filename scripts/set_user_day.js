 ...
 * 
 * Usage:
 *   node scripts/set_user_day.js <SERVICE_ROLE_KEY> <DAYS_BACK>
 *
 * Example:
 *   node scripts/set_user_day.js <SERVICE_ROLE_KEY> 2   # Sets started_at back by 2 days, unlocking Day 3
 */
...
if (!SERVICE_ROLE_KEY) {
  ...
  console.error("Usage: node scripts/set_user_day.js <SERVICE_ROLE_KEY> [DAYS_BACK]\n");
